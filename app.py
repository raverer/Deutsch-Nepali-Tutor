...
# app.py
# Streamlit: Deutsch–Nepali–English Interactive Tutor with Speech
...
def load_models():
    ...
    model_name_ne_en = "Helsinki-NLP/opus-mt-ne-en"
    ...
    return (tok_de_en, mod_de_en, tok_en_de, mod_en_de, tok_en_ne, mod_en_ne, tok_ne_en, mod_ne_en, whisper_asr)
...
def translate(text, source_lang, target_lang):
    ...
    elif source_lang == "Nepali" and target_lang == "English":
        inputs = tok_ne_en(text, return_tensors="pt", padding=True)
        outputs = mod_ne_en.generate(**inputs)
...
# Streamlit Interface
# --------------------------------
source_lang = st.selectbox("🎙️ Select Source Language", ["German", "English", "Nepali"])
